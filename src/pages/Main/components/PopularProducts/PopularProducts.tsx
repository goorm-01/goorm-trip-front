...
export default function PopularProducts({ products, count = 5, onAddToCart, onReserve }: PopularProductsProps) {
            ...
            >
                ...
                <div className="flex items-center gap-2">
                    <button
                        ...
                        style={{ borderColor: cartHovered ? COLORS.CART : COLORS.INFO_BOX, color: cartHovered ? COLORS.BUTTON_MAIN : COLORS.TEXT_SUB }}

...
export default function QuantityControl({ quantity, onChange, min = 1 }: QuantityControlProps) {
    return (
        <div className="flex items-center gap-1">
            ...
            <span className="w-5 text-center text-sm cursor-default" data-testid="quantity-value">
                {quantity}
            </span>
            <button
                type="button"
